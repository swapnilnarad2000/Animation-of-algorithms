#############################--Algorithm-Animation(Swapnil Narad 11841140)--#####################################
(1) Languages used : cytoscape.js(Build v3.12.1) library from Javascript,HTML5,CSS.
(2) For generating animation you will require code.js , cytoscape.min.js , index.html , style.css in same folder.
(3) You will need a browser to run the index.html file(no internet required).
INSRUCTIONS STEPS:
...
**(6)While generating the custom graph the vertices may overlap so please drag them for convenience.**
**(7)<Reload> button is provided to which resets the page to default graph status.**